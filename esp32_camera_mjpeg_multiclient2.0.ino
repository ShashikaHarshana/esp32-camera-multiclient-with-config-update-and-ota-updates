...
#define URL_fw_Version "https://raw.githubusercontent.com/ShashikaHarshana/Esp32---OTA-updates/main/bin-version.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/ShashikaHarshana/Esp32---OTA-updates/main/fw.bin"
...
void mjpegCB(void* pvParameters) {
  ...
  server.on("/control", HTTP_GET, handleConfigUpdate);
  server.on("/otaGit", HTTP_GET, handleOtaGit);
  server.on("/otaSd", HTTP_GET, handleOtaSD);
...
//====== Handle config control via HTTP =========================================

void handleConfigUpdate(void)
{

  int quality = server.arg("quality").toInt();
  Serial.println("before.................................");
  Serial.println(cam.getWidth());
  Serial.println(cam.getFrameSize());

  if (cam.deinit() != ESP_OK) {
    Serial.println("Error initializing the camera");
  } else {
    Serial.println("deinit success......");
  }
  ...
  if (cam.init(config) != ESP_OK) {
    ...
    Serial.println("Camera reinitialization successful....");
  }
  Serial.println("after.................................");
  Serial.println(cam.getWidth());
  Serial.println(cam.getFrameSize());

  // Send an HTTP response indicating whether the configuration was successful or not
  server.send(200, "text/plain", "Quality configuration updated successfully");
}

//=================================== Handle OTA github ==============================

void handleOtaGit(void)
{
  ...
  // Send an HTTP response indicating whether the configuration was successful or not
  server.send(200, "text/plain", "OTA update in progress");
}

//=================================== Handle OTA SD card ==============================

void handleOtaSD(void)
{
